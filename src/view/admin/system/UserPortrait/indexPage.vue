<template>
    <list-page :data="listPageConfig">
        ...
        <template v-slot:tableColumn>
            ...
            <el-table-column sortable align="center" label="总金额" prop="allMoney" show-overflow-tooltip/>
            <el-table-column sortable align="center" label="余额" prop="balances" show-overflow-tooltip/>
            <el-table-column align="center" label="最近一条短信" prop="content" show-overflow-tooltip/>
            <el-table-column sortable align="center" label="金额" prop="dM" show-overflow-tooltip/>
            <el-table-column sortable align="center" label="时间" prop="dT" show-overflow-tooltip/>
            <el-table-column sortable align="center" label="用户id" prop="id" show-overflow-tooltip/>
            <el-table-column sortable align="center" label="金额" prop="money" show-overflow-tooltip/>
