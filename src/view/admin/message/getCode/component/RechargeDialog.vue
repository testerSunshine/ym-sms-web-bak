  ...
  <abstract-dialog :loading="loading" :title="title" :value="value" @close="cancel" @open="open">
    <abstract-form :model="form" :rules="rules">
      <el-form-item label="卡密" prop="cardId">
        ...
        <el-button type="success" round><el-link style="color: white;" href="https://www.ysfaka.com/links/95FA5D22" target="_blank" :underline="false" @click.native="sendBp">卡密商城</el-link></el-button>
        <br>
        <el-button type="success" round><el-link style="color: white;" href="https://www.ccys66.com/links/98965896" target="_blank" :underline="false" @click.native="sendBp">备用卡密商城1</el-link></el-button>
        <br>
        <el-button type="success" round><el-link style="color: white;" href="https://www.51jingzan.cn/links/F7D9F4E0" target="_blank" :underline="false" @click.native="sendBp">备用卡密商城2</el-link></el-button>
        <br>
