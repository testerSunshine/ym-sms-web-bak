  ...
  <abstract-dialog :loading="loading" :title="title" :value="value" @close="cancel" @open="open">
    <abstract-form :model="form" :rules="rules">
      <el-form-item label="卡密" prop="cardId">
        ...
        <br>
        <el-button type="success" round style="margin-top: 5px"><el-link style="color: white;" href="https://www.ccys66.com/links/98965896" target="_blank" :underline="false" @click.native="sendBp">卡密商城1</el-link></el-button>
        <br>
        <el-button type="success" round style="margin-top: 5px"><el-link style="color: white;" href="https://www.ysfaka.com/links/95FA5D22" target="_blank" :underline="false" @click.native="sendBp">卡密商城2</el-link></el-button>
        <br>
